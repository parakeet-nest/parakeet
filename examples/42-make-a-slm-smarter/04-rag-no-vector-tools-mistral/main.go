...
func IsSearchTool(ollamaUrl string, model string, question string) (bool, SearchTool, error) {
	...
	fmt.Println("🟢 Search tool", strings.Trim(result, " "))
...
func main() {
	...
	*/
	...
	for {
		...
		isSearch, searchTool, err := IsSearchTool(ollamaUrl, toolModel, question)
