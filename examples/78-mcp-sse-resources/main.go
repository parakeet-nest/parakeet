...
func main() {
	...
	readRequest.Params.URI = "instructions://mcp-system"
	...
	systemMCPInstructions := resourceResult.Contents[0].(map[string]interface {})["text"].(string)

	//readRequest = mcp.ReadResourceRequest{}
	readRequest.Params.URI = "instructions://chat-system"
	...
	systemChatInstructions := resourceResult.Contents[0].(map[string]interface {})["text"].(string)
