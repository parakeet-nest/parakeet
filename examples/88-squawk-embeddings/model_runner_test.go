...
func TestEmbeddingsWithModelRunner(t *testing.T) {
	...
	fmt.Println("Model Runner Base URL:", modelRunnerBaseUrl)
	fmt.Println("Model Runner LLM Chat:", model)
	fmt.Println("Model Runner LLM Embeddings:", embeddingsModel)
	fmt.Println("====================================")
