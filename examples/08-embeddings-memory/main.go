...
func main() {
	...
	var embeddingsModel = "mxbai-embed-large:latest" // This model is for the embeddings of the documents
	var smallChatModel = "qwen2.5:1.5b"   // This model is for the chat completion
